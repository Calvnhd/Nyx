...
void APProjectileBase::OnProjectileHit(UPrimitiveComponent* HitComponent, AActor* OtherActor,
...

{
	...
	if (OtherActor && OtherActor != GetInstigator())
	{
		...
		if (OtherActor->Implements<UPAttributeInterface>())
		{
			...
			IPAttributeInterface::Execute_ApplyDamage(OtherActor, DamageAmount);
		}
...
void APProjectileBase::PostInitializeComponents()
{
	...
	SphereComp->OnComponentHit.AddDynamic(this, &APProjectileBase::OnProjectileHit);
}
